...
static const char* aboutString = R"ver(
...
static const char* helpString = R"about(
 <h1>DFIT Analysis Version 1</h1>
 ...
 <h2>Open Source</h2>
 <p>This program is released as open source under Mozilla Public License (MPL) v2. The complete source code may be obtained from</p>
